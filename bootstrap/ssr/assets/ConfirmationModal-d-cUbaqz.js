...
import { createBlock, createVNode, mergeProps, openBlock, renderSlot, useSSRContext, withCtx } from "vue";
			...
			_push(ssrRenderComponent(_sfc_main$1, mergeProps({
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`</div>`);
					} else return [createVNode("div", { class: "bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4" }, [createVNode("div", { class: "sm:flex sm:items-start" }, [createVNode("div", { class: "mx-auto shrink-0 flex items-center justify-center size-12 rounded-full bg-red-100 sm:mx-0 sm:size-10" }, [(openBlock(), createBlock("svg", {
